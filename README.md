...
**Не чекај погреб за да кажеш нешто убаво.**
...
| Kudoboard, Tribute | една табла, за еден повод | еднократно, и врзано за роденден или за погреб |
...
- **„Емоционална прокрастинација“** — јапонското *seizensō* (погреб додека си жив) постои затоа што чекаме уште еден празник, уште една година.
